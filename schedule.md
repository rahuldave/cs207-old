...
| F29     | [software engineering](https://github.com/iacs-cs207/cs207/blob/master/lectures/ADT.ipynb)                     | operator overloading, obj model | More trees         |                                          |
| F29 lab | [software engineering](https://github.com/iacs-cs207/cs207/blob/master/labs/distribute_ADT_lab.ipynb) | add ops between TS using operator overloading and multimethods(do synthetic) | trees (R)                 | add between-time series ops including distance |

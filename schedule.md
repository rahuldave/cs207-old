...
| F29     | software engineering                     | operator overloading, obj model | More trees         |                                          |
| F29 lab | software engineering | add ops between TS using operator overloading and multimethods(do synthetic) | trees (R)                 | add between-time series ops including distance |

...
| M07     | [CLIs and setup.py ](https://github.com/iacs-cs207/cs207/blob/master/lectures/MyPackage.ipynb)                       | DSLs and ASTs                            | Metadata and Query Languages             |                                          |
| M07 lab | [pip, make package](https://github.com/rahuldave/stupidlang)                        | start repl for tsdb@home                 | enhance dsl with metadata selection from dicts | add simple query repl on db              |
